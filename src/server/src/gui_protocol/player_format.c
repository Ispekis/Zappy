...
void fmt_player_inv(int fd, client_t player)
{
    ...
    player.pos.y, player.inventory.food.quantity,
    player.inventory.linemate.quantity, player.inventory.deraumere.quantity,
    player.inventory.sibur.quantity, player.inventory.mendiane.quantity,
    player.inventory.phiras.quantity, player.inventory.thystame.quantity);
}
